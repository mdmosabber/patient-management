...
const Create = (props) => {
    ...
    return (
        <AuthenticatedLayout
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight"> Create Patient Info </h2>}
        >
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="grid md:grid-cols-2 grid-cols-1">
                                ...
                                <div className='p-2'>
                                    ...
                                    />
                                    {errors.filename && <p className='text-red-500 mt-1'>{errors.image}</p>}
